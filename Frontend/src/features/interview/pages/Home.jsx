...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (!jobDescription.trim()) {
            setErrorMessage("Please paste the target job description.")
            return
        }
        ...
        try {
            ...
            console.log(error)
            setErrorMessage(
                error?.response?.data?.message || "Something went wrong while generating your report. Please try again."
            )
        }
    }
        ...
        <div className='home-page'>
            ...
            <div className='interview-card'>
                ...
                <div className='interview-card__footer'>
                    {errorMessage && <span className='footer-error'>{errorMessage}</span>}
